  ...
  <div class="custom-file">
   ...
   <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="email" name="email" value="<?=$data['emailid']?>" class="form-control" id="email" placeholder="name@gmail.com">
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" value="<?=$data['skype']?>" class="form-control" name="skype" id="skype" placeholder="@kc250">
    </div>
